...
# File list
search_criteria = "gebco_08_rev_elev_D*.tif"
...
for fp in file_list:
    ...
    if src.crs is None:
        ...
        # Write to a new file
        with rasterio.open('new_file.tif', 'w', driver='GTiff', height=height, width=width, count=1, dtype=src.dtypes[0], crs=dst_crs, transform=dst_transform) as dst:
            reproject(
        ...
        src = rasterio.open('new_file.tif')
    print(f"CRS: {src.crs}")
